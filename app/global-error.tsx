...
export default function GlobalError({
  ...
  return (
    <html lang="fa" dir="rtl">
      <body className="bg-zinc-950 text-zinc-200 flex flex-col items-center justify-center min-h-screen p-6 text-center">
        <div className="text-6xl text-amber-500 mb-4 font-serif">⚠️</div>
        <h2 className="text-3xl font-serif text-amber-100 mb-2">خطای سیستمی رخ داده است</h2>
